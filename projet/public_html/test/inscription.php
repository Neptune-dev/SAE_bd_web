<html>
    ...
    <body>
        ...
        <form action="#" method="POST">
            ...
            <input type="text" id="" name="mdp" required placeholder="Entrez votre ancien mots de passe">

            <label for="nom">Nouveau mots de passe</label>
            <input type="text" id="" name="mdp1" required placeholder="Entrez votre nouveau mots de passe">

            <label for="nom">Confirmez le mots de passe</label>
            <input type="text" id="" name="mdp2" required placeholder="Retapez votre nouveau mots de passe">
